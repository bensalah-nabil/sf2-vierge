...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'fos_rest.request_matcher.0c2930ff89b85a57b4e1e7eec9e23a0f11b32e81bb9e1a0e8b2e9cc89667e6227ba2f382' => 'getFosRest_RequestMatcher_0c2930ff89b85a57b4e1e7eec9e23a0f11b32e81bb9e1a0e8b2e9cc89667e6227ba2f382Service',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => NULL, 'port' => NULL, 'dbname' => NULL, 'user' => NULL, 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/ExampleBundle/Resources/config/doctrine') => 'ExampleBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'ExampleBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('ExampleBundle' => 'ExampleBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_24f11556a876aa133bc0958558258bc087d76a7e5f3fc470f57d47fa1baeb04d');
    ...
    protected function getFosRest_ExceptionFormatNegotiatorService()
    {
        ...
        $instance->add($this->get('fos_rest.request_matcher.0c2930ff89b85a57b4e1e7eec9e23a0f11b32e81bb9e1a0e8b2e9cc89667e6227ba2f382'), array('priorities' => array(0 => 'xml', 1 => 'json'), 'fallback_format' => 'xml', 'prefer_extension' => '2.0', 'methods' => NULL, 'stop' => false));
        $instance->add($this->get('fos_rest.request_matcher.0dfc4cce134bee15f08405cb5cea4845b13ff7d8c8f779004218432a2c552bd0cd9f9d27'), array('priorities' => array(0 => 'text/html', 1 => '*/*'), 'fallback_format' => 'html', 'prefer_extension' => '2.0', 'methods' => NULL, 'stop' => false));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/ExampleBundle/Resources/views'), 'Example');
    ...
    /**
     * Gets the private 'fos_rest.request_matcher.0c2930ff89b85a57b4e1e7eec9e23a0f11b32e81bb9e1a0e8b2e9cc89667e6227ba2f382' shared service.
     *
     * @return \Symfony\Component\HttpFoundation\RequestMatcher
     */
    protected function getFosRest_RequestMatcher_0c2930ff89b85a57b4e1e7eec9e23a0f11b32e81bb9e1a0e8b2e9cc89667e6227ba2f382Service()
    {
        return $this->services['fos_rest.request_matcher.0c2930ff89b85a57b4e1e7eec9e23a0f11b32e81bb9e1a0e8b2e9cc89667e6227ba2f382'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/stackoverflower', NULL, NULL);
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('6588aa632696d9.17601525')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ExampleBundle' => 'ExampleBundle\\ExampleBundle',
            ...
            'kernel.bundles_metadata' => array(
                ...
                'ExampleBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/ExampleBundle'),
